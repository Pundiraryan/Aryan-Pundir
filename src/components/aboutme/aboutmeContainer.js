                ...
                <Row>
                    ...
                    <Col ms={12} className="mt-3 d-flex flex-column">
                        <div>
                            ...
                            <Nav.Item>
                                <Nav.Link as={Link} to="toolkit" eventKey="link-2" style={{ fontSize: "17px",fontWeight:700 }}>Skills</Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
                                <Nav.Link as={Link} to="educationjourney" eventKey="link-3" style={{ fontSize: "17px",fontWeight:700 }}>Education & Experience </Nav.Link>
                            </Nav.Item>
                            <Nav.Item>
